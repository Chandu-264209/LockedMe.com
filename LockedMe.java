...
static String fileName;
	...
	static final String errorMessage = "Some error has occured, Please contact: admin@chandu.com";
	/**
	...
	public static void displayMenu() {
		...
		System.out.println("\t\tDeveloper Details: A Chandu Chary");
		System.out.println("*******************************************");
	}
...
//		Creating a try-catch block 
		try {
			...
			if (filenames.contains(fileName)) {
				...
				System.out.println("The file you're searching is not available");
			}
